...
Ext.define('MyApp.view.comp.DateChooserView', {
	 ...
	 */
	initModel: function(){
		if(!Ext.ModelManager.isRegistered('DateChooserViewModel')) // TODO: Throws an error in opening Ext.ux.TouchCalendar.html example?? 
		{
			Ext.define('DateChooserViewModel', {
	...
	applyViewMode: function(viewMode){
        ...
        var viewModeFns = MyApp.view.comp.DateChooserView[viewMode.toUpperCase()];
	...
	populateStore: function(){
		...
		for(var i = 0; i < totalDays; i++){
            ...
            record = Ext.create('DateChooserViewModel', {
	...
	/**
	 * Returns the DateChooserViewModel model instance containing the passed in date
	 * @method
	 * @privatee
	 * @param {Date} date
	 */
	...
	statics: {
		...
		MONTH: {
				...
				getStartDate: function(date){
					return Ext.bind(MyApp.view.comp.DateChooserView.WEEK.getStartDate, this)(new Date(date.getFullYear(), date.getMonth(), 1));
				},
