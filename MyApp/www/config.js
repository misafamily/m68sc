...
AppConfig.textData.NHAP_SO_TIEN = 'NHẬP SỐ TIỀN GIAO DỊCH';
AppConfig.textData.NHAP_SO_TIEN_ATM = 'NHẬP SỐ TIỀN HIỆN CÓ';
...
AppConfig.textData.PRESS_BACK_TO_EXIT = "Nhấn lại để thoát";
AppConfig.textData.BUTTON_OK = "XÁC NHẬN";
AppConfig.textData.BUTTON_CANCEL = "TRỞ LẠI";
AppConfig.textData.CHUA_CHON_CHI_TIEU = "Chưa chọn loại chi tiêu";
AppConfig.textData.CHUA_CHON_THU_NHAP = "Chưa chọn loại thu nhập";
AppConfig.textData.NHAP_TIEN_SAI = "Số tiền nhập phải > 0 đ";
AppConfig.textData.HET_TIEN_MAT = "Tiền mặt hiện có <strong>{0}<strong>, không đủ để thực hiện giao dịch";
